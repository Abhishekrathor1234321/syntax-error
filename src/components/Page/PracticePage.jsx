...
import { CheckCircle2, Circle, Zap, Flame, Skull, ExternalLink } from "lucide-react";
...
const diffBadge = {
  Easy: { label: "E", cls: "bg-green-500 text-white" },
  Medium: { label: "M", cls: "bg-yellow-500 text-white" },
  Hard: { label: "H", cls: "bg-red-500 text-white" },
};
      ...
      <div style={{ paddingTop: "56px" }}>
        <div style={{ maxWidth: "672px", margin: "0 auto", padding: "32px 20px" }}>
          ...
          <AnimatePresence mode="wait">
            <motion.div key={topicFilter} variants={container} initial="hidden" animate="show" style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
